"""
MALLORN v76: LightGBM on v34a Features

Testing LightGBM as alternative to XGBoost.

LightGBM advantages:
1. Leaf-wise tree growth: can find deeper patterns
2. Histogram-based: faster training
3. GOSS (Gradient-based One-Side Sampling): better for imbalanced data
4. Often better generalization on tabular data
...
print("=" * 80, flush=True)
print("MALLORN v76: LightGBM on v34a Features", flush=True)
print("=" * 80, flush=True)
...
# 3. TRAIN LIGHTGBM
# ====================
print("\n3. Training LightGBM...", flush=True)
...
submission_path = base_path / 'submissions/submission_v76_lightgbm.csv'
...
with open(base_path / 'data/processed/v76_artifacts.pkl', 'wb') as f:
...
print(f"""
   ...
   v76 LightGBM             {len(available_features)}        {best_f1:.4f}   ???

   LightGBM uses leaf-wise growth which may find different patterns.
   scale_pos_weight={scale_pos_weight:.1f} handles TDE imbalance.
""", flush=True)

print("=" * 80, flush=True)
print("v76 Complete", flush=True)
print("=" * 80, flush=True)
